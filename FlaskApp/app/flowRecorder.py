...
class FlowRecorder(BaseClass):
    ...
    def _run_live(self):
        ...
        print("1. "+str(self.config.get_value("maxlen")))
        print("2. "+str(self.config.get_value("promiscuous")))
        print("3. "+str(self.config.get_value("read_timeout")))
        # Instantiate sniffer:
        print("nummm:",self.interface_number)
        self.interface = _getInterface(self.interface_number)
